...
title: "Wikipedia:Vandalism:Language Page: Vandal classification"
author: "bdanalytics"
...
Data: 
Source: 
    Training:   https://courses.edx.org/c4x/MITx/15.071x_2/asset/wiki.csv  
    New:        <newdt_url>  
Time period: 

```{r set_global_options_wd, echo=FALSE}
setwd("~/Documents/Work/Courses/MIT/Analytics_Edge_15_071x/Assignments/HW5_Wikipedia_Vandalism")
```
...
glb_trnng_url <- "https://courses.edx.org/c4x/MITx/15.071x_2/asset/wiki.csv"
...
glb_txt_vars <- c("Added", "Removed")   
glb_append_stop_words <- NULL # or c("<freq_word>") 
glb_sprs_threshold <- 0.9970
...
glb_out_pfx <- "Wikpedia_Vandalism_"
